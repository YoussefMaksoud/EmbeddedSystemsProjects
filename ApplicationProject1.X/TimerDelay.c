...
void timer3Init(){
    ...
    IPC2bits.T3IP2 = 1; //set priority to 7
    IPC2bits.T3IP1 = 1;
    IPC2bits.T3IP0 = 1;
...
void __attribute__((interrupt, no_auto_psv))_T3Interrupt(void){
    ...
    delay_ms(200);
    count_down = 0;
    reset = 1; //if this interrupt triggers, it means pb3 was pressed for long enough to cause a reset, raise the flag
}
